...
const initialProfileSettingsState: ProfileSettingsActionState = {
    status: "idle",
    message: "",
}
...
export default function ProfilePage() {
    ...
    const [profileState, profileAction, profilePending] = useActionState(updateProfileSettings, initialProfileSettingsState)
    ...
    const profileMessage = message ?? (
        profileState.status === "idle"
            ? null
            : { type: profileState.status, text: profileState.message }
    )
        ...
        <div className="space-y-5">
            ...
            <form action={profileAction} className="space-y-5">
                ...
                <div className="bg-card rounded-xl border border-border p-5 space-y-4">
                    ...
                    <input type="hidden" name="showStreak" value={String(showStreak)} />
                    <input type="hidden" name="showWorkouts" value={String(showWorkouts)} />
                    <input type="hidden" name="showPRs" value={String(showPRs)} />
                    <input type="hidden" name="showWeight" value={String(showWeight)} />
                    <input type="hidden" name="publicAnalytics" value={String(publicAnalytics)} />
